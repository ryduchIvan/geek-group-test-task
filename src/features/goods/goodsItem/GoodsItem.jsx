		...
		<div className="col-12 col-sm-6 col-xl-4 goods__item">
			 <Card className="goods__card">
     		 ...
     		 <Card.Body className="p-0 mt-3">
				...
				{
					title && title.length === correctTitle.length ? <Card.Title className="goods__card-title">{title}</Card.Title>: <Card.Title className="goods__card-title">{correctTitle}...</Card.Title>
				}
